...
export default function AdminContractRequestsPage() {
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            case 'pending':
                return <Badge variant="secondary" className="bg-yellow-100 text-yellow-800">รอประเมิน</Badge>;
            case 'quoted':
                return <Badge variant="secondary" className="bg-blue-100 text-blue-800">แจ้งราคาแล้ว</Badge>;
            case 'completed':
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold font-headline">คำขอร่าง/ตรวจสอบสัญญา</h1>
            </div>
                                    ...
                                    <TableRow key={request.id}>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span>
                                                    {request.serviceType === 'draft' && 'ร่างสัญญาใหม่'}
                                                    {request.serviceType === 'review' && 'ตรวจสอบสัญญา'}
                                                    {request.serviceType === 'consult' && 'ปรึกษากฎหมาย'}
                                                    {request.serviceType === 'other' && 'อื่นๆ'}
                                                </span>
                                            </div>
                                        </TableCell>
